    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if payment_method == "mpesa":
                ...
                msisdn = form.cleaned_data['phone']  # dynamic MSISDN
                purchased_items = ", ".join([item.product.name for item in order.items.all()])
                ...
                try:
                    ...
                    return render(request, "orders/mpesa_pending.html", {
                        "order": order,
            ...
            elif payment_method in ["mixx", "airtel", "stripe"]:
                return render(request, f"orders/{payment_method}_pending.html", {"order": order})
